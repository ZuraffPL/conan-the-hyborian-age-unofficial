...
export class ConanActor extends Actor {
   ...
   * Character + NPC (minion/antagonist): logika obsługiwana przez TypeDataModel.prepareDerivedData().
   */
  prepareDerivedData() {
    // Wszystkie typy aktorów obsługiwane są przez TypeDataModel.prepareDerivedData()
  }
